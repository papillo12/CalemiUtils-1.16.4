...
public class InventoryHelper {
    ...
    private static boolean isStackValidForSlot(Object obj, ItemStack stack, int slotId) {
        ...
        if (obj instanceof CCItemHandler) {
            return ((CCItemHandler)obj).isItemValid(slotId, stack);
        }
    ...
    private static ItemStack getStackInSlot(Object obj, int slotId) {
        ...
        if (obj instanceof CCItemHandler) {
            return ((CCItemHandler)obj).getStackInSlot(slotId);
        }
    ...
    private static void setStackInSlot(Object obj, ItemStack stack, int slotId) {
        ...
        if (obj instanceof CCItemHandler) {
            ((CCItemHandler)obj).setStackInSlot(slotId, stack);
        }
    }
    ...
    private static void decreaseCountFromSlot(Object obj, int slot, int decreaseAmount) {
        ...
        if (obj instanceof CCItemHandler) {
            ((CCItemHandler)obj).decrStackSize(slot, decreaseAmount);
        }
    }
    ...
    public static void breakInventory (World world, CCItemHandler inventory, Location location) {
